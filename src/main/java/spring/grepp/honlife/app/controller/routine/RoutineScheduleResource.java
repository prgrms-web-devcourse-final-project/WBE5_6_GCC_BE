...
public class RoutineScheduleResource {
    ...
    public RoutineScheduleResource(final RoutineScheduleService routineScheduleService) {
    ...
    public ResponseEntity<Integer> createRoutineSchedule(
            @RequestBody @Valid final RoutineScheduleDTO routineScheduleDTO) {
        final Integer createdId = routineScheduleService.create(routineScheduleDTO);
        return new ResponseEntity<>(createdId, HttpStatus.CREATED);
    }

    @PutMapping("/{id}")
    public ResponseEntity<Integer> updateRoutineSchedule(
            @PathVariable(name = "id") final Integer id,
            @RequestBody @Valid final RoutineScheduleDTO routineScheduleDTO) {
    ...
    public ResponseEntity<Void> deleteRoutineSchedule(@PathVariable(name = "id") final Integer id) {
