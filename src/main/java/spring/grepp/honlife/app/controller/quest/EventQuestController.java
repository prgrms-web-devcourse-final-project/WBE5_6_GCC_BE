...
import spring.grepp.honlife.app.model.quest.service.EventQuestService;
...
public class EventQuestController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<EventQuestDTO> getEventQuest(@PathVariable(name = "id") final Long id) {
