package spring.grepp.honlife.member_badge.rest;
...
import spring.grepp.honlife.member_badge.service.MemberBadgeService;


@RestController
@RequestMapping(value = "/api/memberBadges", produces = MediaType.APPLICATION_JSON_VALUE)
public class MemberBadgeResource {

    private final MemberBadgeService memberBadgeService;

    public MemberBadgeResource(final MemberBadgeService memberBadgeService) {
