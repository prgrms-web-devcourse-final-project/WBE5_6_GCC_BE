package spring.grepp.honlife.member_badge.service;

import java.util.List;
import org.springframework.data.domain.Sort;
import org.springframework.stereotype.Service;
import spring.grepp.honlife.badge.domain.Badge;
import spring.grepp.honlife.badge.repos.BadgeRepository;
...
import spring.grepp.honlife.member_badge.model.MemberBadgeDTO;
...
public class MemberBadgeService {
    ...
    public MemberBadgeDTO get(final Integer id) {
        return memberBadgeRepository.findById(id)
                .map(memberBadge -> mapToDTO(memberBadge, new MemberBadgeDTO()))
                .orElseThrow(NotFoundException::new);
    }

    public Integer create(final MemberBadgeDTO memberBadgeDTO) {
    ...
    public void update(final Integer id, final MemberBadgeDTO memberBadgeDTO) {
