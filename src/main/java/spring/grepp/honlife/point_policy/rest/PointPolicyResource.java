package spring.grepp.honlife.point_policy.rest;
...
import spring.grepp.honlife.point_policy.service.PointPolicyService;


@RestController
@RequestMapping(value = "/api/pointPolicies", produces = MediaType.APPLICATION_JSON_VALUE)
public class PointPolicyResource {

    private final PointPolicyService pointPolicyService;

    public PointPolicyResource(final PointPolicyService pointPolicyService) {
