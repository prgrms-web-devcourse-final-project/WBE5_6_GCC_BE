package spring.grepp.honlife.event_quest.rest;
...
import spring.grepp.honlife.event_quest.service.EventQuestService;


@RestController
@RequestMapping(value = "/api/eventQuests", produces = MediaType.APPLICATION_JSON_VALUE)
public class EventQuestResource {

    private final EventQuestService eventQuestService;

    public EventQuestResource(final EventQuestService eventQuestService) {
