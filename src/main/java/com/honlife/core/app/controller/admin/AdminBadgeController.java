...
@RequestMapping(value = "/api/v1/admin//badge", produces = MediaType.APPLICATION_JSON_VALUE)
public class AdminBadgeController {
  ...
  @PostMapping
  public ResponseEntity<CommonApiResponse<String>> registerBadge(@RequestBody BadgeDTO request, Authentication authentication) {
  ...
  public ResponseEntity<CommonApiResponse<String>> deleteBadge(
      @PathVariable Long badgeId,
      Authentication authentication
  ) {
    if (badgeId == 9999L) {
